...
public class CustomMessage {
	...
	public static final String UPLOAD_SUCCESS_MESSAGE = " has been uploaded successfully!";
	
	public static final String Lagout_SUCCESS_MESSAGE = " User Logged Out successfully! ";
